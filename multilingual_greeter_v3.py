...
# import random to get a random greeting...
import random
...
greetings_dict = {
    ...
    2: ["Hola", "Buenos días", "Saludos"], 
    3: ["Hallo", "Guten Tag", "Grüß dich"], 
    4: ["你好", "您好", "哈喽"],
    5: ["Halo", "Selamat pagi", "Salam"]
}

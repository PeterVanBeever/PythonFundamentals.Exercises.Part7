...
lang_dict = {1: "English", 2:"Spanish",3:"Dutch", 4:"Chinese"}

# Populate this dictionary with appropriate prompts that correspond with the ids from lang_dict.
# Example: Key = 1. Value = 'What is your name?'.
name_prompt_dict = {1: "What is your name?", 2: "¿Cómo te llamas?", 3: "Hoe heet je?",  4: "你叫什麼名字？"}

# Populate this dictionary with appropriate prompts that correspond with the ids from lang_dict.
# Example: Key = 1. Value = 'Hello'.
greetings_dict = {1: "Hello", 2: "Hola!", 3: "Hallo!", 4: "你好"}
